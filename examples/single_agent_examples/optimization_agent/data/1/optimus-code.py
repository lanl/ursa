...
# Load data
with open(
    "/Users/gaowenzhi/Desktop/optimus-OR-paper/data/new_dataset/sample_datasets/1/parameters.json",
    "r",
) as f:
    data = json.load(f)
...
InvestmentDetachedHouses = model.addVar(
    vtype=GRB.CONTINUOUS,
    lb=MinimumInvestmentDetachedHouses,
    name="InvestmentDetachedHouses",
)
...
model.addConstr(
    InvestmentCondos
    >= MinimumPercentageCondos * (InvestmentCondos + InvestmentDetachedHouses)
)
