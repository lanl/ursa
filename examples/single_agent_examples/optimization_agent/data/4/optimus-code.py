...
# Load data
with open(
    "/Users/gaowenzhi/Desktop/optimus-OR-paper/data/new_dataset/sample_datasets/4/parameters.json",
    "r",
) as f:
    data = json.load(f)
...
model.addConstr(
    NumberLongCables * GoldPerLong + NumberShortCables * GoldPerShort
    <= TotalGold
)
...
model.setObjective(
    ProfitPerLong * NumberLongCables + ProfitPerShort * NumberShortCables,
    GRB.MAXIMIZE,
)
