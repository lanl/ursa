...
messages = Path("./messages/executor") # logs are saved here 
...
- [X] log user initial prompts
- [X] log flow of text to include systems, user, and assistant back and forth
      prompts
- [X] reasoning summaries
- [ ] log agents output (e.g.: hypothesizer, critique steps - plan json for
      later analysis, etc).

[1]: https://github.com/lanl/ursa/blob/main/src/ursa/agents/base.py
