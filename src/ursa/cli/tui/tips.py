...
TIPS = (
    ...
    "{skill_macro} picks a skill; {skill_macro}name activates it for that prompt.",
    "Skills also activate themselves when your request matches one.",
    "Use {command_macro}skills to see every discovered skill.",
