...
```bash
jobs/wave-validation-45a54c7a39d3249a/run-wave.sh easy ursa-docker
jobs/wave-validation-45a54c7a39d3249a/run-wave.sh easy codex-docker
jobs/wave-validation-45a54c7a39d3249a/run-wave.sh easy ursa-apptainer
jobs/wave-validation-45a54c7a39d3249a/run-wave.sh easy codex-apptainer
```
